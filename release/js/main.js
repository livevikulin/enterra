...
/* harmony import */ var _import_polyfil__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./import/polyfil */ "./src/js/import/polyfil.js");
/* harmony import */ var _import_polyfil__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_import_polyfil__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _import_players_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./import/players.json */ "./src/js/import/players.json");
var _import_players_json__WEBPACK_IMPORTED_MODULE_3___namespace = /*#__PURE__*/__webpack_require__.t(/*! ./import/players.json */ "./src/js/import/players.json", 1);




renderTable(_import_players_json__WEBPACK_IMPORTED_MODULE_3__);
onlinePLayer();
var search = document.querySelector('.js-input');
search.addEventListener('input', function (_ref) {
  var target = _ref.target;
  var newPlayers = _import_players_json__WEBPACK_IMPORTED_MODULE_3__.filter(function (player) {
...
function renderTable(players) {
  players.forEach(function (obj) {
    ...
    td3.className = 'td';
    td3.innerHTML = "<div class=\"rating\">".concat(getStars(obj.level), "</div>");
    td4.className = 'td';
    td4.innerHTML = "<span class=\"online ".concat(obj.online ? "on" : "off", "\"></span>");
    tr.className = 'tr';
    moreInfo.className = 'more-info';
    moreInfo.innerHTML = "<a href=\"#\" class=\"show-profile\">\u041F\u043E\u043A\u0430\u0437\u0430\u0442\u044C \u043F\u0440\u043E\u0444\u0438\u043B\u044C</a><a href=\"#\" class=\"hide-player\">\u0421\u043A\u0440\u044B\u0442\u044C \u0438\u0433\u0440\u043E\u043A\u0430</a>";
...
function onlinePLayer() {
  var checkboxInput = document.querySelector('.js-checkbox'),
  ...
  checkboxInput.addEventListener('click', function () {
    ...
    tr.forEach(function (obj) {
      obj.closest('.tr').style.display = _this.checked ? "none" : "flex";
    });
  });
}
...
if (tbody !== null) {
  tbody.addEventListener("click", function (e) {
    var node = e.target;
    var isTR = node.closest(".tr");
    var isShowProfile = e.target.classList.contains("show-profile");
    var modalInfo = document.querySelector('.modal');
    var isHideBtn = e.target.classList.contains("hide-player");
    var info = isTR.querySelector(".more-info");
...
function putModalInfo(nodeTr) {
  var name = nodeTr.dataset.name;
  var stars = nodeTr.dataset.stars;
  var online = nodeTr.dataset.online;
  var modalInfo = document.querySelector('.modal');
